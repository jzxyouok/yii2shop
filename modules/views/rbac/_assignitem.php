                ...
                <div class="container">
                    ...
                    */
                    ...
                    <div class="span12 field-box">
                        <?php
                            echo Html::label('角色名称',null).Html::encode($parent);
                        ?>
                    </div>
                    <div class="span12 field-box">
                        <?php
                            echo Html::label('角色子节点',null).Html::checkboxList('children', isset($children['roles'])?$children['roles']:[], $roles);
                        ?>
                    </div>
                    <div class="span12 field-box child-node">
<!--                        permission-->
                        <?php
                            echo Html::label('权限子节点',null).Html::checkboxList('children', isset($children['permissions'])?$children['permissions']:[], $permissions);
                        ?>
                    </div>
