    ...
    <ul class="product-list">
        ...
        <li class="sidebar-product-list-item">
            <div class="row">
                ...
                <div class="col-xs-8 col-sm-8 no-margin">
                    <a href="#"><?php echo $pro['title']; ?>hp </a>
                    <div class="price">
                        <div class="price-prev"><?php echo $pro['price']; ?></div>
                        <div class="price-current"><?php echo $pro['saleprice']; ?></div>
                    </div>
                        ...
                        <div class="row no-margin">
                            ...
                            <div class="col-xs-12 col-sm-4 no-margin product-item-holder hover">
                                <div class="product-item">
                                    ...
                                    <?php endif; ?> 
                                    <?php if($pro['istui']): ?>
                                    <div class="ribbon blue"><span>Recommend</span></div>
                                    <?php endif; ?>
                                    ...
                                    <div class="hover-area">
                                        ...
                                        <div class="wish-compare">
                                            <a class="btn-add-to-wishlist" href="#">加入购物清单</a>
                                            <a class="btn-add-to-compare" href="#">比较</a>
                                        </div>
                                    </div>
                                </div><!-- /.product-item -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="result-counter">
                                    Showing <span>1-6</span> of <span><?php echo $count;?></span> results
                                </div>
                            </div>
