              ...
              <div class="col-xs-12 col-sm-12 col-md-6 top-search-holder no-margin">
                <div class="contact-row">
                  ...
                  <div class="contact inline">
                    <i class="fa fa-envelope"></i> contact@<span class="le-color">2924811900@qq.com</span>
                  </div>
                </div><!-- /.contact-row -->
                <!-- ============================================================= SEARCH AREA ============================================================= -->
<!--                  搜索部分-->
                <div class="search-area">
                    ...
                    <div class="control-group">
                      ...
                      <a class="search-button" href="javascript:document.getElementById('w3').submit();" ></a>
