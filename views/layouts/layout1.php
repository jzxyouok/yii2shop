              ...
              <ul>
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="<?php echo yii\helpers\Url::to(['member/auth']); ?>">Login/Register</a></li><li><a href="http://www.moke8.com">More</a></li>
                  </ul>
                </li>
              </ul>
            </div><!-- /.col -->
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
              <ul class="right">
                ...
                <?php if (\Yii::$app->session['isLogin'] ==1): ?>
                  欢迎回来 <?php echo \Yii::$app->session['loginname']; ?>,<a href="<?php echo yii\helpers\Url::to(['member/logout']); ?>">退出</a> 
                <?php else: ?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 top-cart-row no-margin">
                  <div class="top-cart-row-container">
                    <div class="wishlist-compare-holder">
                      <div class="wishlist ">
                        <a href="#"><i class="fa fa-heart"></i> 愿望清单<span class="value">(21)</span> </a>
                      </div>
                      <div class="compare">
                        <a href="#"><i class="fa fa-exchange"></i> 对比 <span class="value">(2)</span> </a>
                      </div>
                    </div>
                  ...
                  <div class="row no-margin widgets-row">
                    <div class="col-xs-12  col-sm-4 no-margin-left">
                              ...
                              <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-3 no-margin">
                                  <a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => $pro->productid]); ?>" class="thumb-holder">
                                    <img alt="<?php echo $pro->title; ?>" src="assets/images/blank.gif" data-echo="<?php echo $pro->cover ?>-piclistsmall" />
                                  </a>
                                </div>
                              </div>
                            </li>
                      ...
                      <div class="link-list-row">
                        ...
                        <!-- 更换主题颜色 -->
                        <script src="assets/switchstylesheet.js"></script>
                        <script>
